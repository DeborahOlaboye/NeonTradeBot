...
async function testEndToEnd() {
  ...
  try {
    ...
    try {
      ...
      console.log('Agent Configuration (Expected Error - Mock Data):', configError.response?.data?.error || configError.message);
    }
    ...
    try {
      ...
      console.log('Crossmint (Expected - No API Keys):', crossmintError.response?.data?.error || crossmintError.message);
    }
    ...
    console.log('Crossmint Integration: REQUIRES API KEYS');
    console.log('Blockchain Transactions: REQUIRES FUNDED WALLET');
